        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if (header.indexOf("GET /26/on") >= 0) {
              ...
              // Display static text
              display.println(output26State + "|" + output27State);
            ...
            // Web Page Heading
            client.println("<body><h1>LED and Screen</h1>");
            // Moisture

            //client.println("<p>Value" + value + "</p>");
            
            // Display current state, and ON/OFF buttons for GPIO 26  
            client.println("<p>Pin GPIO 26 - State " + output26State + "</p>");
            ...
            client.println("<p>Pin GPIO 27 - State " + output27State + "</p>");
